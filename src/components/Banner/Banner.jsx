            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <p className="text-sm text-gray-500 tracking-wide leading-5">
                 We are a Food Resturant in Pune  near.......................
                  <br />
                  <br />
                  We are a famous resturant in Pune people loves our food in Pune we have so many food options veg , non- veg, chinese , italian people loves our food u can give a vist we pleased to welcome you.
                </p>
